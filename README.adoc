...
* `ghcr.io/rhpds/ftl:latest`
* `quay.io/rhpds/ftl:latest`

[source,bash]
----
# Build and push to both registries
podman build -t quay.io/rhpds/ftl:latest -t ghcr.io/rhpds/ftl:latest .
...
FTL_IMAGE=ghcr.io/rhpds/ftl:latest grade_lab <lab> user1 --podman
----
